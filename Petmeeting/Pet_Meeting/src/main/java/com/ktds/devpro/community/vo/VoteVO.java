...
//
//	String pname="";
//	int prevPrice = -1;		// �븷�씤 �쟾 媛�寃�(寃고빀 �긽�뭹留� 媛� 蹂�寃�)
//	int totalPrice = 0;		// 珥� 湲덉븸
//	String total_service="";	// 遺�媛��꽌鍮꾩뒪 �궡�슜
//	
//	boolean combine = false;	// �떒�씪�씠硫� false, 寃고빀�씠硫� true
//
//	public ResultVO() {
//	}
//
//	public ResultVO(int tvId, String tvName, String tvQuality, int tvChannel, int tvDue, int tvPrice, String tvService,
